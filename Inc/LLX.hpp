...
namespace LL1
{
    ...
    template <typename T>
    using dynamic_token_sequence_t = std::vector<int_type_t<T>>;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // parsing error handling utilities
    ////////////////////////////////////////////////////////////////////////////////////////////////
	...
	struct static_look_ahead_buffer
	{
        ...
        constexpr void push_back(int_type tok)
        {
            ...
            assert(this->begin_index <= this->end_index);
        }
	...
	{
		return std::any_of(std::begin(cmp), std::end(cmp), tok);
	}
	...
	{
		return std::any_of(std::begin(cmp), std::end(cmp), bis.peek());
	}
	...
	{
		dynamic_token_sequence_t<T1> tokseq;
	...
	{
		dynamic_token_sequence_t<T> tokseq;
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_if(input_stream_t<T1>& bis, T2 cmp)
	{
		if(is(bis, cmp))
			ignore(bis);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_if(input_stream_t<T1>& bis, const token_set_t<T2, N>& cmp)
	{
		if(is(bis, cmp))
			ignore(bis);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_if(input_stream_t<T1>& bis, code_position& pos, T2 cmp)
	{
		if(is(bis, cmp))
			ignore(bis, pos);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_if(input_stream_t<T1>& bis, code_position& pos, const token_set_t<T2, N>& cmp)
	{
		if(is(bis, cmp))
			ignore(bis, pos);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_if_not(input_stream_t<T1>& bis, T2 cmp)
	{
		if(is_not(bis, cmp))
			ignore(bis);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_if_not(input_stream_t<T1>& bis, const token_set_t<T2, N>& cmp)
	{
		if(is_not(bis, cmp))
			ignore(bis);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_if_not(input_stream_t<T1>& bis, code_position& pos, T2 cmp)
	{
		if(is_not(bis, cmp))
			ignore(bis, pos);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_if_not(input_stream_t<T1>& bis, code_position& pos, const token_set_t<T2, N>& cmp)
	{
		if(is_not(bis, cmp))
			ignore(bis, pos);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T, Ts...>>
	>
	void ignore_if_one_of(input_stream_t<T>& bis, Ts... cmp)
	{
		if(is_one_of(bis, cmp...))
			ignore(bis);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T, Ts...>>
	>
	void ignore_if_one_of(input_stream_t<T>& bis, code_position& pos, Ts... cmp)
	{
		if(is_one_of(bis, cmp...))
			ignore(bis, pos);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T, Ts...>>
	>
	void ignore_if_none_of(input_stream_t<T>& bis, code_position& pos, Ts... cmp)
	{
		if(is_none_of(bis, cmp...))
			ignore(bis, pos);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_while(input_stream_t<T1>& bis, T2 cmp)
	{
		while(is(bis, cmp))
			ignore(bis);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_while(input_stream_t<T1>& bis, const token_set_t<T2, N>& cmp)
	{
		while(is(bis, cmp))
			ignore(bis);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_while(input_stream_t<T1>& bis, code_position& pos, T2 cmp)
	{
		while(is(bis, cmp))
			ignore(bis, pos);
	}
	...
	template <
		...
		typename = std::enable_if_t<are_compatible_token_types_v<T1, T2>>
	>
	void ignore_while(input_stream_t<T1>& bis, code_position& pos, const token_set_t<T2, N>& cmp)
	{
		while(is(bis, cmp))
			ignore(bis, pos);
	}
